...
####################################################
#files exe
pkequal=/home/luciano/astro/fisher/lib/PKequal-master/pkequal.exe
emu=/home/luciano/astro/fisher/lib/FrankenEmu/emu.exe
####################################################

#input
echo "enter output root"
read root
...
echo 'spectra written in ${root}_emu_z$z.dat files'
