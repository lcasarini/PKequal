	...
	!Jun 16: extended Halofit from w=const. models to w=w(a) with 
	!PKequal spectral equivalence described in : 
	!Casarini, Macció and Bonometto (2009), &
	!Casarini, Bonometto, Tessarotto and Corasaniti (2016).
    ...
    integer, parameter :: halofit_default = halofit_casarini
